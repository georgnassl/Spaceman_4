...
public class CurrentListOfWords {
  ...
  /**
   * Creates an initial CurrentListOfWords-Instance with a starting CurrentListOfWords-list in
   * WordToGuess-format. This list is supposed to be updated after every guess.
   *
   * @return a CurrentListOfWords. @TODO: Turn System.out.println into comment for the Praktomat.
   */
  ...
  /**
   * Converts the List of strings from Database to a List of WordToGuess to work with in case of a
   * guess. This list is supposed to be updated after every guess.
   *
  ...
  /**
   * Converts the List of WordToGuess to a List of String to compare it with the current WordToGuess
   * (as String).
   *
   * @return a List of String.
   */
  public ArrayList<String> convertToCurrentListOfWordsAsString(
      ArrayList<WordToGuess> currentListOfWords) {
  ...
  /**
   * Compares the given List of WordToGuess (converted as String) to the given current WordToGuess
   * (converted as String).
   *
   * @return a updated List of WordToGuess matching to the currentWord.
   */
  public ArrayList<WordToGuess> updateCurrentListOfWords(
      ArrayList<WordToGuess> formerCurrentListOfWords, WordToGuess currentWord) {
   ...
   */
  public void revealCharactersInWholeList(
      ArrayList<WordToGuess> formerCurrentListOfWords, char guessedCharacter) {
